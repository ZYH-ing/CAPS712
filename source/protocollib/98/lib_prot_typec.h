...
typedef struct
{
	...
	volatile uint8_t rising_edge_debounce;
	volatile bool b_vbus_level;
	volatile bool b_vbus_rising_edge;
	volatile bool b_attached_snk_prepare;
	volatile bool b_attached_src_prepare;
 ...
 * @{
 */
extern void typeca_hard_reset_cb(void);
extern void typecb_hard_reset_cb(void);
